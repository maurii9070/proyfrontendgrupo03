...
@Component({
  selector: 'app-resetear-password-paciente',
  imports: [ReactiveFormsModule, CommonModule],
  templateUrl: './resetear-password-paciente.component.html',
  styleUrl: './resetear-password-paciente.component.css'
})
export class ResetearPasswordPacienteComponent {
